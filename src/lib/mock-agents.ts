/**
 * Static dummy data for the Desktop Agents page.
...
export const AGENT_PLATFORMS: AgentPlatform[] = [
  { os: "Windows", label: "Windows 10 / 11", file: `WorkPulseAgent-${LATEST_AGENT_VERSION}.msi`, size: "24 MB" },
  { os: "macOS", label: "macOS 12 and later", file: `WorkPulseAgent-${LATEST_AGENT_VERSION}.dmg`, size: "21 MB" },
  { os: "Linux", label: "Ubuntu / Debian", file: `workpulse-agent_${LATEST_AGENT_VERSION}_amd64.deb`, size: "19 MB" },
]
