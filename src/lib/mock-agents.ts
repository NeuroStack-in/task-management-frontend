...
export const AGENT_RELEASE_VERSION = "0.1.7";

export const AGENTS: Agent[] = [
  {
    id: "ag-1",
    hostname: "alex-morgan-mbp",
    user: "Alex Morgan",
  ...
  {
    id: "ag-3",
    hostname: "daniel-kim-mbp",
    user: "Daniel Kim",
    email: "daniel.kim@acme.test",
    os: "macOS",
    osVersion: "13.6",
    version: "2.3.0",
    status: "idle",
  ...
  {
    id: "ag-4",
    hostname: "sara-lopez-win",
    user: "Sara Lopez",
    email: "sara.lopez@acme.test",
    os: "Windows",
    osVersion: "10",
    version: "2.4.0",
    status: "online",
  ...
  {
    id: "ag-5",
    hostname: "tom-becker-ubuntu",
    user: "Tom Becker",
    email: "tom.becker@acme.test",
    os: "Linux",
  ...
  {
    id: "ag-6",
    hostname: "maya-patel-mbp",
    user: "Maya Patel",
    email: "maya.patel@acme.test",
    os: "macOS",
    osVersion: "14.4",
    version: "2.4.1",
    status: "idle",
  ...
  {
    id: "ag-7",
    hostname: "rosa-diaz-win",
    user: "Rosa Diaz",
    email: "rosa.diaz@acme.test",
    os: "Windows",
    osVersion: "11",
    version: "2.2.5",
    status: "offline",
  ...
  {
    id: "ag-8",
    hostname: "liam-chen-mbp",
    user: "Liam Chen",
    email: "liam.chen@acme.test",
    os: "macOS",
    osVersion: "14.5",
    version: "2.4.1",
    status: "online",
  ...
  {
    id: "ag-9",
    hostname: "nina-roy-win",
    user: "Nina Roy",
    email: "nina.roy@acme.test",
    os: "Windows",
    osVersion: "11",
    version: "2.4.0",
    status: "offline",
  ...
  {
    id: "ag-10",
    hostname: "omar-said-fedora",
    user: "Omar Said",
    email: "omar.said@acme.test",
    os: "Linux",
    osVersion: "Fedora 39",
    version: "2.4.1",
    status: "online",
...
const PROJECTS = [
  {
    name: "Atlas Platform",
    tasks: ["Billing webhook retries", "Schema migration", "Audit trail"],
  },
  { name: "Orion Mobile", tasks: ["Offline sync", "Push permissions", "Crash triage"] },
  {
    name: "Helios Analytics",
    tasks: ["Cohort report", "Query cache", "Dashboard polish"],
  },
  {
    name: "Internal Tools",
    tasks: ["Onboarding flow", "Access review", "Runbook update"],
  },
];
...
export function getAgentDetail(agentId: string): AgentDetail | null {
  ...
  return {
    ...
    outboxMb: offline
      ? Number((rng() * 24 + 3).toFixed(1))
      : Number((rng() * 1.4).toFixed(1)),
    cadenceMins,
    blurLevel: int(0, 2),
    retentionDays: 90,
    autoUpdate: rng() > 0.2,
