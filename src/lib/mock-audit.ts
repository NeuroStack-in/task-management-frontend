...
export const AUDIT_EVENTS: AuditEvent[] = [
  ...
  { id: "log-1005", timestamp: "2026-06-25 09:15", actorName: "Sara Lopez", actorEmail: "sara.lopez@acme.test", action: "Approved time-off request", category: "approvals", target: "Tom Becker · Jun 30 – Jul 2", ip: "192.0.2.140", device: "Chrome on Windows", status: "success" },
  ...
  { id: "log-1014", timestamp: "2026-06-23 10:05", actorName: "Maya Patel", actorEmail: "maya.patel@acme.test", action: "Exported timesheet (CSV)", category: "time", target: "Week 25", ip: "198.51.100.5", device: "Safari on iPhone", status: "success" },
  ...
  { id: "log-1018", timestamp: "2026-06-22 09:33", actorName: "System", actorEmail: "system@acme.test", action: "Desktop agent went offline", category: "monitoring", target: "daniel-kim-mbp", ip: "203.0.113.51", device: "WorkPulse Desktop Agent", status: "warning" },
  ...
  { id: "log-1021", timestamp: "2026-06-21 10:12", actorName: "Tom Becker", actorEmail: "tom.becker@acme.test", action: "Started timer", category: "time", target: "Apollo Redesign · Frontend", ip: "198.51.100.77", device: "WorkPulse Desktop Agent", status: "success" },
