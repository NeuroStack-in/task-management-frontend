      ...
      <div className="max-w-4xl space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Determine when a user is considered idle and how that time is classified.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-0 pb-2">
            ...
            <SettingRow
              label="Count idle as break"
              description="Log idle periods as break time rather than untracked time."
              disabled={!canManage}
            >
              <Switch
                checked={draft.idle.countIdleAsBreak}
                disabled={!canManage}
                onCheckedChange={(v) => updateIdle({ countIdleAsBreak: v })}
              />
            </SettingRow>
          </CardContent>
        </Card>
