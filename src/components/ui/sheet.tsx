...
function SheetOverlay({ className, ...props }: SheetPrimitive.Backdrop.Props) {
  return (
    <SheetPrimitive.Backdrop
      ...
      className={cn(
        "fixed inset-0 z-50 bg-black/25 duration-[var(--sheet-in)] supports-backdrop-filter:backdrop-blur-xs data-open:animate-in data-open:fade-in-0 data-open:ease-enter data-closed:animate-out data-closed:fade-out-0 data-closed:duration-[var(--sheet-out)] data-closed:ease-exit",
        className
      )}
      {...props}
    />
